...
// @name         OMXHelper
// @version      1.2
// @description  Permet de rajouter un bouton pour copier coller sans se fatiguer !
// @author       Lyes
...
function polymerInject(){
    ...
    addButton.appendChild(document.createTextNode("OMXMe"));
...
function run(){
    ...
    if(!document.getElementById("parentButton") && window.location.href.substring(0, 25).indexOf("youtube.com") > -1 && window.location.href.indexOf("watch?") > -1){
        ...
        childButton.appendChild(document.createTextNode("OMXMe"));
